...
export default {
    ...
    argTypes: {
        ...
        priorityColor: {
            control: { type: 'select', options: ['text-red-600', 'text-yellow-600', 'text-green-600'] },
        },
        dueDate: { control: 'date' },
        status: {
            control: { type: 'select', options: ['Aberta', 'Em progresso', 'Fechada'] },
        },
        statusColor: {
            control: { type: 'select', options: ['bg-cyan-blue', 'bg-yellow-500', 'bg-dark-gray'] },
        },
        type: {
